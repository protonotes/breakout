...
class BreakOut(tk.Frame):
    def __init__(self, master):
        super(BreakOut, self).__init__(master)
        self.lives = 3
        self.width = 610
        self.height = 400
...
class Paddle(GameObject):
    def __init__(self, canvas, x, y):
        ...
        self.height = 10
        self.ball = None
        item = canvas.create_rectangle(x - self.width,
                                       y - self.height,
                                       x + self.width,
                                       y + self.height,
                                       fill='blue')
...
class Block(GameObject):
    ...
    def __init__(self, canvas, x, y, hits):
        ...
        item = canvas.create_rectangle(x - self.width / 2,
                                       ...
                                       fill=color,
                                       tags='block')
        super(Block, self).__init__(canvas, item)
